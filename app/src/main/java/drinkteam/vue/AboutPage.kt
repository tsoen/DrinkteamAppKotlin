...
import drinkteam.layouts.AboutPageLayout
import org.jetbrains.anko.AnkoContext

/**
 * Created by Timothée on 18/06/2016.
 *
 * Page (Fragment) "A propos de nous" accessible depuis le menu
 */
class AboutPage : Fragment()
{
	...
	override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View
	{
		...
		return AboutPageLayout().createView(AnkoContext.create(context as MainActivity, activity as MainActivity))
	}
