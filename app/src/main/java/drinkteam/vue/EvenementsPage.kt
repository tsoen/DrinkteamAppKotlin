...
import drinkteam.layouts.EvenementsPageLayout
import org.jetbrains.anko.AnkoContext

/**
 * Created by Timothée on 18/06/2016.
 *
 * Page (Fragment) "Evénements" accessible depuis le menu
 */
class EvenementsPage : Fragment()
{
	/**
	...
	override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View?
	{
		...
		return EvenementsPageLayout().createView(AnkoContext.create(context as MainActivity, context as MainActivity))
	}
